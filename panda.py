...
print(df.to_string())
plt.plot(df['Duration'],df['Calories'],color='red',label='Calories')
plt.plot(df['Duration'],df['Maxpulse'],color='blue',label='Maxpulse')
plt.plot(df['Duration'],df['Pulse'],color='green',label='Pulse')
plt.plot(df['Duration'],df['Duration'],color='yellow',label='Duration')
plt.legend()
plt.xlabel("Duration")
plt.ylabel("Calories")
plt.show()
